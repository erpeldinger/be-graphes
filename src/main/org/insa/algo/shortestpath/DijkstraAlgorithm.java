...
public class DijkstraAlgorithm extends ShortestPathAlgorithm {
    ...
    //Cette m�thode permet de cr�er un Label associ� � un Node
    protected Label creerLabel(Node sc, ShortestPathData data) {
		return new Label(sc);
	}

    //Cette m�thode permet de cr�er un Label null
    ...
    public ShortestPathSolution doRun() {
        ...
        for (Node courantNode : this.data.getGraph().getNodes()) {
        	...
        	//On r�cup�re l'index du label du noeud de destination
        ...
        //Notifie les observateurs du d�part de l'origine
        ...
        while(!tas.isEmpty() && !(labelDest.marked())) {
        	...
        	//Notifie les observateurs que le sommet courant a �t� marqu�
